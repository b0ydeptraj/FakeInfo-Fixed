...
- Read the Agent Skills Spec carefully before starting: `.codex/skills/agent_skills_spec.md`
...
- Full path: `./.codex/skills/<skill-name>/SKILL.md`
- Script files (if any): `./.codex/skills/<skill-name>/scripts/my-script.py` or `./.codex/skills/<skill-name>/scripts/my-script.sh`
- Reference files (if any): `./.codex/skills/<skill-name>/references/ref-0.md`
