...
SystemConfig_CFLAGS = -fobjc-arc -fobjc-arc-exceptions -Wno-error -Wno-error=incomplete-implementation -Wno-deprecated-declarations -Wno-unused-variable -Wno-arc-performSelector-leaks -Wno-incomplete-implementation
