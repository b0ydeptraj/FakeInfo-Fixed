...
SystemConfig_CFLAGS = -fobjc-arc -Wno-error -Wno-error=incomplete-implementation -Wno-deprecated-declarations -Wno-unused-variable -Wno-arc-performSelector-leaks -Wno-incomplete-implementation
